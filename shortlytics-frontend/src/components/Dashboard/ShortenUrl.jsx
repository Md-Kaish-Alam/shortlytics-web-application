...
const ShortenUrl = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
  ...
  }, [navigate, selectedUrl, shortUrl, token]);
    ...
    <div className="bg-slate-100 shadow-lg border border-dotted border-slate-500 px-6 sm:py-1 py-3 rounded-md transition-all duration-100">
      ...
      <React.Fragment>
        <div
          ...
          } max-h-96 sm:mt-0 mt-5 min-h-96 relative border-t-2 border-slate-300 w-[100%] overflow-hidden`}
        >
          {isLoading ? (
            <div className="min-h-[calc(450px-140px)] flex justify-center items-center w-full">
              <div className="flex flex-col items-center gap-1">
                <Hourglass
                  ...
                  height="50"
                  width="50"
                  ariaLabel="hourglass-spinner-loading"
                  wrapperStyle={{}}
                  wrapperClass=""
              ...
              {analyticsData.length === 0 && (
                <div className="absolute flex flex-col justify-center sm:items-center items-end w-full left-0 top-0 bottom-0 right-0 m-auto">
                  <h1 className="text-slate-800 sm:text-2xl text-[15px] font-bold mb-1">
                    No Analytics Available for this time period
                  </h1>
                  <h3 className="sm:w-96 w-[90%] sm:ml-0 pl-6 text-center sm:text-lg text-[12px] text-slate-600">
                    Share your shortened link to gain insights into where your
                    audience interactions originate.
                  </h3>
                </div>
              )}
