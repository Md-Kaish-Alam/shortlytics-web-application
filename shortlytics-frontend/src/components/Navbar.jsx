    ...
    <div className="h-24 bg-custom-gradient  z-50 flex items-center sticky top-0 ">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between items-center">
        ...
        >
          ...
          {!token && (
            <Link to="/register">
              <li className=" sm:ml-0 -ml-1 bg-white text-btn  cursor-pointer w-24 text-center font-semibold px-2 py-2 rounded-md  hover:text-blue-800-300   transition-all duration-150">
                SignUp
              </li>
            </Link>
          )}
